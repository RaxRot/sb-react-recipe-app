...
class CommentRepositoryTest {
    ...
    @Test
    void findByRecipeId_shouldReturnAllForRecipe() {
        List<Comment> forR1 = commentRepository.findByRecipeId(r1.getId());
        List<Comment> forR2 = commentRepository.findByRecipeId(r2.getId());

        assertThat(forR1).hasSize(2);
        assertThat(forR1).extracting(Comment::getComment)
    ...
    @Test
    void findByUserId_shouldReturnAllForUser() {
        List<Comment> forU1 = commentRepository.findByUserId(u1.getId());
        List<Comment> forU2 = commentRepository.findByUserId(u2.getId());
